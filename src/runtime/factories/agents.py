...
def register_agents(*, clients: ClientContainer, registries: RegistryContainer) -> None:
    ...
    legal_agent = LegalAgent(llm_client=clients.llm_client, retriever=retriever)
    contract_agent = ContractAgent(llm_client=clients.llm_client, retriever=retriever)
