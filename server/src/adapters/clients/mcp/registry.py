...
resolution pattern, different core.
...
from core.dto.clients.mcp import MCPServerConfig, MCPToolCallResult
from core.exceptions.mcp import MCPServerNotConfiguredError
